...
void loop() {
  unsigned long start_time = millis();
    ...
    char *ptString = "I got 1 ";
    printf ("Plaint text is: %s\n ", stringToHex(ptString));
...
// Error Found for 64 bits of Iinput "I got 1 in "
// Rebooting...
...
// entry 0x403c98d4
// Before Enc PT is (C): 4920676F74203120
//  Encrypte text is: 110111100011100010000101000000000000000086109B9F
// assert failed: block_trim_free heap_tlsf.c:371 (block_is_free(block) && "block must be free")


// Backtrace: 0x40376ff6:0x3fceb7e0 0x4037a1b5:0x3fceb800 0x4037f94d:0x3fceb820 0x4037edea:0x3fceb950 0x4037f48d:0x3fceb970 0x4037f5bc:0x3fceb990 0x403773ab:0x3fceb9b0 0x403773bd:0x3fceb9e0 0x403773e6:0x3fceba00 0x4037f95d:0x3fceba20 0x4200216d:0x3fceba40 0x4200230a:0x3fceba60 0x420034dd:0x3fcebc50
