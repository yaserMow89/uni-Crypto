...
public class Main {
    ...
    public static void main(String[] args) 
    {
        ...
        if (myKey.length() == 192 && ptString != null) {
            ...
            String key2 = myKey.substring(64, 128);
            String key3 = myKey.substring(128, 192);

            generate_keys(key1);
            String encryptedText = des_encrypt_text(ptString);
            generate_keys(key2);
        ...
        {
            throw new IllegalArgumentException("Values either empty or unsupported lengths");
        }
    }
